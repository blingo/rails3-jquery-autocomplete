...
This version adds the ability to search on several fields.
To enable searching on several fields you'll need to pass :columns_names => [:field1, :field2]

Example:
    autocomplete: archive, :name, :columns_names => [:name,: short_name]

Thus, the data will be searched by columns :name and :short_name, but will be displayed as :name.
